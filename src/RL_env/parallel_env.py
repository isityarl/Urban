...
# def worker(remote, cfg, net, gui, step_length, env_id):
...
#         for env_id, remote in enumerate(self.workers):
#             p = mp.Process(target=worker,
#                            args=(remote, cfg, net, gui, step_length, env_id))
#             p.daemon = True
#             p.start()
#             self.ps.append(p)
